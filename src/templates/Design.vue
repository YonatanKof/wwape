<template>
    <Layout>
        ...
        <div class="post-title">
            <!-- <h2 class="post-title__text">{{ $page.design.title }}</h2> -->
            <!-- <PostMeta :postmeta="$page.design" /> -->
        </div>
        <div class="post">
            <div class="post__header">
                <g-image
                    v-if="$page.design.cover_image"
                    :src="$page.design.cover_image"
                    :alt="$page.design.cover_caption"
                />
            </div>
            <div class="post__content">
                <VueRemarkContent />
                <div class="post__footer">
                    <PostTags :posttags="$page.design" />
                </div>
            </div>
        </div>
